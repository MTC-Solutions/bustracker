...
<div class="register-boxl">
    <div class="register-logo">
        <a href="{{ url(config('adminlte.dashboard_url', 'home')) }}"><b>Edit</b> Trip</a>
    </div>
            ...
            <div class="row">
                    <div class="col-md-6">
                        <div class="form-group has-feedback {{ $errors->has('departureTime') ? 'has-error' : '' }}">
                            <input id="timepicker" data-toggle="tooltip" title="click the time icon to insert time." data-placement="bottom" type="text" name="departureTime" class="form-control" value="{{ $trip->departureTime }}"
